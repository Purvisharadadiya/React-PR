                ...
                {categoryList.map((cat) => (
                  <li key={cat}>
                    ...
                    <small className="count">
                      {products.filter((p) => p.mainCategory === "Women" && p.category === cat).length}
                    </small>
                  </li>
                ))}
              </ul>
              ...
              <ul className="filter-list mt-3">
                {brandList.map((brand) => (
                  <li key={brand}>
                    ...
                    <small className="count">
                      {products.filter((p) => p.mainCategory === "Women" && p.brand === brand).length}
                    </small>
                  </li>
                ))}
              </ul>
              ...
              <ul className="filter-list mt-3">
                {patternList.map((pattern) => (
                  <li key={pattern}>
                    ...
                    <small className="count">
                      {products.filter(
                        (p) => p.mainCategory === "Women" && p.pattern?.includes(pattern)
                      ).length}
                    </small>
                  </li>
                ))}
